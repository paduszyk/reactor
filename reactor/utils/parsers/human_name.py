...
class HumanName(Parser):
    ...
    @property
    def full(self):
        return self._get_full_name(reversed_=False)

    @property
    def full_reversed(self):
        return self._get_full_name(reversed_=True)

    @property
    def short(self):
        return self._get_short_name(reversed_=False)

    @property
    def short_reversed(self):
        return self._get_short_name(reversed_=True)
