...
class Person(models.Model):
    """Represents a person profile associated with a user."""
...
class Subgroup(models.Model):
    """Represents a subgroup of contracts within a group."""
...
class Position(models.Model):
    """Represents the position of a contract."""
...
class Contract(models.Model):
    """Represents a contract between a person and a unit."""
